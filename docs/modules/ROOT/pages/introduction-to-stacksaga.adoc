...
. *xref:retry-ring-coordinator:transaction-retrying-with-retry-coordinator.adoc[Retry Subsystem]* +
A robust transaction retry subsystem for asynchronous retry scheduling using token ring partitioning and the Retry Coordinator.
