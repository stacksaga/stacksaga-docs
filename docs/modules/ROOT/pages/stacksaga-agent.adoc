// SEO Metadata
:page-title: Stacksaga Agent - Transaction Retry and Consistent Hashing in Microservices
:page-description: Detailed guide on how Stacksaga Agent handles asynchronous transaction retries, consistent hashing, and deployment in microservices.
:page-keywords: stacksaga agent, transaction retry, microservices, event-store, consistent hashing, deployment
