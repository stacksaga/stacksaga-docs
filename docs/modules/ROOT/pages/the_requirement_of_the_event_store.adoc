...
+
StackSaga offers a dashboard called xref:trace-window:stacksaga-trace-window.adoc[Stacksaga Cloud-Window], which allows you to monitor transaction tracing details and review any errors related to transactions.
