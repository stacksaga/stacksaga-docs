...
image:stacksaga-old-aggregator.drawio.svg[Stacksaga Old Aggregator Version,100%]

*New Changes For Existing Aggregator Structure.*

. *Making changes in aggregator's class.*
+
image:stacksaga-aggregator-change.drawio.svg[Stacksaga Making Aggregator Changes,100%]
...
image:stacksaga-executor-class-change.drawio.svg[Stacksaga Making Executors Changes,100%]
+
