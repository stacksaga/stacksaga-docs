...
image::microservice-high-level-diagram.svg[alt="Microservice High Level Diagram",width=100%,opts=interactive,height=100vh]

* **Spring Microservice Architecture With StackSaga**
+
image::stack-saga-high-level-diagram.svg[alt="StackSaga High-level architecture",width=100%,opts=interactive,height=100vh]
