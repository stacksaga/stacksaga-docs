...
image::microservice-high-level-diagram.png[alt="Microservice High Level Diagram",height=300]

* **Spring Microservice Architecture With StackSaga**
+
image::stack-saga-high-level-diagram.svg[alt="StackSaga High-level architecture",height=300]
