...
image:stacksaga-diagram-eureka-service-registry-regional-architecture.drawio.svg[alt="stacksaga diagram eureka service registry regional architecture"]
...
image:stacksaga-diagram-eureka-service-registry-zonal-architecture.drawio.svg[alt="stacksaga diagram eureka service registry zonal architecture"]
