...
All the transactions are retired within a specific duration that you configured.
It ensures not accumulating the transactions that cannot be invoked successfully by invoking many times.
