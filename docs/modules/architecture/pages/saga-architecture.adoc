...
* *Distributed Transactions:* Saga break down a large transaction into a series of smaller, independent transactions that can be managed separately across different services.
