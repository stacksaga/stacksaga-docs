...
As per the architecture xref:extra:version_casting_architecture.adoc[documentation], StackSags does support Aggregator Event xref:architecture:version_casting_architecture.adoc#aggregator_oriented_up_casting[UpCasting]
