...
image:domain-entity/stacksaga-diagram-aggregator-change-add-new-data.drawio.svg[alt="stacksaga diagram aggregator change add new data"]
...
image:domain-entity/stacksaga-diagram-aggregator-change-remove-data.drawio.svg[alt="stacksaga diagram aggregator change remove data"]
...
image:domain-entity/Architecture-Stacksaga-aggregator-oriented-up-casting-view.drawio.svg[Stacksaga aggregator version up-casting]
...
image:domain-entity/Architecture-Stacksaga-aggregator-oriented-down-casting-view.drawio.svg[Stacksaga aggregator version down-casting]
