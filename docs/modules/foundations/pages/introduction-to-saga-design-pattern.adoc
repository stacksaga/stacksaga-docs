...
In the next section, let's explore the individual building blocks that make up a Saga — Atomic Transactions — and how to execute and retry them safely with Idempotency.

xref:idempotency.adoc[Continue to Atomic Transactions & Idempotency &#8594;]
