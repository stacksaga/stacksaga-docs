...
A mentioned above after adding the `stacksaga-agent-cassandra-starter` as a dependency, the application should be configured as a leader and als as a follower.
