...
*** xref:implementations:stacksaga-kafka-implementation/architecture.adoc[]
...
*** xref:implementations:stacksaga-kafka/stacksaga-kafka-client/overview.adoc[*Stacksaga Kafka Client*]

*** *Stacksaga-Kafka Service Agent*
