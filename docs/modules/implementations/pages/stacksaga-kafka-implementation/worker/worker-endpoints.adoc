...
these are the topics that define in the in xref:stacksaga-kafka-implementation/orchestrator/topics-event-manager.adoc#custom_topic_implementation[] with type of `SagaEventType.QUERY_DO_ACTION`
