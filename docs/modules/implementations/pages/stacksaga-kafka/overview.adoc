...
| PARTITION_ORDERED`
| The processing mode for the shared response listener. see more xref:#domain_root_topic_event_processing_modes[] for more details about the processing modes.
