...
image:aggregator/Architecture-Stacksaga-aggregator-oriented-up-casting-view.drawio.svg[Stacksaga DomainEntity version up-casting]
...
image:aggregator/Architecture-Stacksaga-aggregator-oriented-down-casting-view.drawio.svg[Stacksaga DomainEntity version down-casting]
