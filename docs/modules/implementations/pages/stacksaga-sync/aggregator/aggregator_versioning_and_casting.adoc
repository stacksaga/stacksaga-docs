...
image:aggregator/stacksaga-diagram-aggregator-change-add-new-data.drawio.svg[alt="stacksaga diagram domain-entity change add new data"]
...
image:aggregator/stacksaga-diagram-aggregator-change-remove-data.drawio.svg[alt="stacksaga diagram domain-entity change remove data"]
...
image:aggregator/Architecture-Stacksaga-aggregator-oriented-up-casting-view.drawio.svg[Stacksaga domain-entity version up-casting]
...
image:aggregator/Architecture-Stacksaga-aggregator-oriented-down-casting-view.drawio.svg[Stacksaga domain-entity version down-casting]
