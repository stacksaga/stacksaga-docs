...
image:common/stack-saga-e-store-example-aggregator-and-executors.drawio.svg[alt="StackSaga Aggregator And Executors",width=100%,opts=interactive,scaledwidth=100%]

== How the Aggregator is used through the Executors

image::common/stack-saga-e-store-example-aggregator-state.drawio.svg[alt="StackSaga Aggregator And Executors",width=100%,opts=interactive,scaledwidth=100%]