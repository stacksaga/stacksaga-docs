...
Because if there is this kind of error, Stacksaga framework notifies the issue into the StackSaga Trace Window. +
...
+
NOTE: At this moment the system doesn't warn you through the StackSaga Trace Window because resources unavailable are accepted by the framework.
