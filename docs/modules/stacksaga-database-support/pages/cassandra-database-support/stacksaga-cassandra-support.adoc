...
:toc-title: Cassandra implementation
...
:doctitle: Stacksaga Cassandra Reactive Support | Cassandra Database Integration Guide
:revnumber: 1.0.0
:revdate: {localdate}
...
include::stacksaga:stacksaga-database-support:secondary-internal-service-for-transaction-retry.adoc[]
