...
image::cassandra/stacksaga-diagram-stacksaga-components-database-support-cassandra.svg[alt="stacksaga components overview with mysql database support", title="Stacksaga components overview with mysql database support"]
