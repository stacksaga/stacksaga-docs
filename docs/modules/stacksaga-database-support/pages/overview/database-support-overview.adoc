...
Likewise, the following database support implementations are available currently.

* xref:mysql-database-support/stacksaga-mysql-support.adoc[stacksaga-mysql-support] — Database support for Mysql
* xref:cassandra-database-support/stacksaga-cassandra-support.adoc[stacksaga-cassandra-support] — Database support for Cassandra
