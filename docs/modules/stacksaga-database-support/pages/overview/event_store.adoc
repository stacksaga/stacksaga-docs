...
xref:retry-ring-coordinator:transaction-retrying-with-retry-coordinator.adoc[Retry Subsystem]. refer to their respective sections for more details with the use-causes.
