...
**** xref:stacksaga-engines:stacksaga-kafka/stacksaga-kafka-client/overview.adoc[overview]
**** xref:stacksaga-engines:stacksaga-kafka/stacksaga-kafka-client/stacksaga-kafka-client-endpoints.adoc[]
