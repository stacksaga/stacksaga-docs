...
public enum PlaceOrderTopic implements SagaTopic<PlaceOrderTopic> {
    ...
    PlaceOrderTopic(float eventKey, String targetServiceName, SagaTopicType sagaEventType, PlaceOrderTopic parent) {
    ...
    PlaceOrderTopic(float eventKey, String targetServiceName, SagaTopicType sagaEventType) {
        this.targetServiceName = targetServiceName;
        this.sagaEventType = sagaEventType;
        this.revert = null;
        this.eventKey = eventKey;
