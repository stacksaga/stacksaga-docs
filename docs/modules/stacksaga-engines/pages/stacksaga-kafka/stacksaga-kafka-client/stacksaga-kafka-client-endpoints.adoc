...
Almost pretty much same as xref:#revert-endpoints-keep-ordering-in-memory-retries[]. additionally,
...
Almost pretty much same as xref:#revert-endpoints-keep-ordering-in-memory-retries[].
But,
