...
In the xref:StackSaga:ROOT:index.adoc[], We got a clear idea of how microservice architecture works, and what are the challenges that we have to face when implementing the microservice in traditional way.
...
image:overview/microservice-high-level-diagram.svg[StackSaga High-level architecture,700]

=== **Spring Microservice Architecture With StackSaga**

image:overview/stack-saga-high-level-diagram.svg[alt="StackSaga High-level architecture",700]
