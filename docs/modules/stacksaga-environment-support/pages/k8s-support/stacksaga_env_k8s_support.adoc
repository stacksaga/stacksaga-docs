...
WARNING: While you are accessing the tracing details via the xref:trace-window:stacksaga-trace-window.adoc[] you might be faced an issue called mixed-content error. refer the solution
xref:trace-window:stacksaga-trace-window.adoc#mixed_content_error[here].
