...
+
image:admin/stacksaga-cloud-window-after-login.png[]

. Create a project +
A unique name should be provided to create a project. +
+
image:admin/stacksaga-cloud-window-create-new-project.png[]
+
Then you will be able to see the project like below in the dashboard.
+
image:admin/stacksaga-cloud-window-after-creating-new-project.png[]
...
+
image:admin/stacksaga-cloud-window-creating-new-service.png[]
+
Then you will be able to see the service like below in the dashboard.
+
image:admin/stacksaga-cloud-window-after-creating-new-service.png[]
...
+
image:admin/stacksaga-cloud-window-creating-new-service-token.png[]
+
...
+
image:admin/stacksaga-cloud-window-copy-created-service-token.png[]
+
[[invited_users]]
...
image:admin/stack-saga-high-level-diagram.svg[alt="StackSaga Admin involvement in the StackSaga ecosystem"]
...
image:admin/stacksaga-admin-service-connector-ui.png[]
...
image:admin/stacksaga-admin-login-successful.png[]

Or otherwise, you will have a 403 error like below.

image:admin/stacksaga-admin-error-403.png[]
...
image:admin/how-stacksaa-admin-fetch-transaction-data.svg[alt="how stacksaa admin fetch transaction data"]
